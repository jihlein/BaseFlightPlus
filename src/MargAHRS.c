                    ...
                    float accelCutoff, uint8_t magDataUpdate, float dt)
{
    ...
    if (MargAHRSinitialized == true)
    {
        ...
        sensors.attitude200Hz[ROLL ] = atan2f( 2.0f * (q0q1 + q2q3), q0q0 - q1q1 - q2q2 + q3q3 );
		sensors.attitude200Hz[PITCH] = -asinf( 2.0f * (q1q3 - q0q2) );
		sensors.attitude200Hz[YAW  ] = atan2f( 2.0f * (q1q2 + q0q3), q0q0 + q1q1 - q2q2 - q3q3 );
    }
}
